...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(21 + 1000, new string[] { "처음  목표는 저희의 식량을 갉아먹는 닭들이에요",
            "오른쪽으로 가시면 저희의 식량창고가 있을거에요 ", "가서 닭들을 10마리 잡아와주세요",});
        talkData.Add(30 + 1000, new string[] { "아직 덜 퇴치하신거 같아요" });
        talkData.Add(31 + 1000, new string[] { "닭들을 전부 퇴치하신건가요?","감사합니다! 다음 목표는 기계 몬스터들이에요",
        "그치만 검만으로는 물리치기 쉽지 않으실 꺼에요" , "제가 드린 편지를 가지고 마법사 슬라임에게 가보세요","마법사 슬라임은 북동쪽에 있답니다"});
        talkData.Add(40 + 2000, new string[] { "이곳에는 무슨일인가?","편지? 아아 이런 사정이 있었군",
            "마법을 알려주는 대신 내 부탁을 하나 들어주시게","요즘 정기적으로 식량이 배송되지 않아서 배고프던 참이였는데",
        "식량창고에 가서 달걀을 3개만 가져다 주시게나"});
        talkData.Add(50 + 4000, new string[] { "달걀뭉치를 획득했다" });
        talkData.Add(51 + 2000, new string[] { "고맙소 은인에게 내 모든 마법을 알려주지","e키를 눌러서 완드를 장비한 상태에서 사용할수있소",
        "마법에 대한 설명은 p키를 눌러서 확인하면 되오","정신력이 부족하면 마법을 사용할 수 없으니 참고하시게나"});
        talkData.Add(60 + 1000, new string[] { "아 모험가님 마법을 배워서 돌아오셨군요 축하드려요!",
        "이제 다음 목표를 수행하기 위해 저희 대왕슬라임님을 찾으러 같이 가도록 해요!"});
        talkData.Add(70 + 3000, new string[] { "자네는 누구인가?","아아 그런일들이 있었군","우리를 도와주신다니 참으로 감사하오",
